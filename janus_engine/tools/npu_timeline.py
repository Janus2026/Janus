# Copyright 2016 The Janus Authors. All Rights Reserved.
#
...
# ==============================================================================
"""Timeline visualization for Janus using Chrome Trace Format."""
...
class Timeline(object):
  """A class for visualizing execution timelines of Janus steps."""

  def __init__(self, log_file_path: str) -> None:
    """Constructs a new Timeline.

    A 'Timeline' is used for visualizing the execution of a Janus
    computation.  It shows the timings and concurrency of execution at
    the granularity of Janus Ops.
