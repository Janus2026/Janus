...
std::tuple<torch::Tensor, std::optional<torch::Tensor>> AttentionImpl::forward(
  ...
  if (!skip_process_cache) {
    ...
    if (k_cache_scale.has_value()) {
      ...
      janus::kernel::quant_to_paged_cache(reshape_paged_cache_params);
    } else {
...
void AttentionImpl::prefill_forward(
  ...
  if (attn_metadata.is_prefill) {
    ...
    if (k_cache_scale.has_value() && k_cache_scale->defined() &&
      ...
      janus::kernel::ReshapeFromCacheParams dequant_params;
      ...
      janus::kernel::dequant_from_paged_cache(dequant_params);
  ...
  janus::kernel::mlu::batch_prefill(query,
                                   key,
                                   value,
                                   output,
                                   output_lse,
...
void AttentionImpl::decoder_forward(
  ...
  janus::kernel::mlu::batch_decode(query,
                                  k_cache,
                                  output,
