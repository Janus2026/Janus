...
ParallelArgs make_tp_args(std::unique_ptr<janus::ProcessGroup>& process_group,
                          int32_t rank,
                          int32_t tp_size) {
...
ParallelArgs make_world_args(std::unique_ptr<janus::ProcessGroup>& process_group,
                             std::unique_ptr<janus::ProcessGroup>& tp_group,
                             int32_t global_rank,
                             int32_t dp_size,
                             int32_t tp_size) {
  process_group = std::make_unique<test::MockProcessGroup>(
...
GatherShape make_gather_shape(const std::vector<int32_t>& dp_tokens,
                              int32_t tp_size) {
  std::unique_ptr<janus::ProcessGroup> process_group;
