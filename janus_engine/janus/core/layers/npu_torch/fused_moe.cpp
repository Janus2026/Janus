...
torch::Tensor FusedMoEImpl::select_experts(
  ...
  janus::kernel::MoeInitRoutingV2Params moe_init_routing_params;
  ...
  auto [expand_hidden_states, expand_row_ids, group_list, dynamic_scale] =
      janus::kernel::moe_init_routing_v2(moe_init_routing_params);
  (void)dynamic_scale;
...
torch::Tensor FusedMoEImpl::forward_expert(
  ...
  janus::kernel::MoeCombineResultParams moe_combine_params;
  ...
  final_hidden_states = janus::kernel::moe_combine_result(moe_combine_params);
