...
#define AUTO_COUNTER(name) \
  janus::AutoCounter SAFE_CONCAT(name, __LINE__)(COUNTER_##name);
...
DECLARE_GAUGE(janus_cpu_num);
DECLARE_GAUGE(janus_cpu_utilization);
DECLARE_GAUGE(janus_gpu_num);
DECLARE_GAUGE(janus_gpu_utilization);
