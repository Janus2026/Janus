...
const OptionCategory kJanusServiceOptions = {"JANUS-SERVICE OPTIONS",
...
class HelpFormatter {
 ...
 public:
  static std::string generate_help() {
    ...
    oss << "USAGE: janus --model <PATH> [OPTIONS]\n\n";
  ...
  static void print_usage() {
    std::cout << "USAGE: janus --model <PATH> [OPTIONS]\n";
    std::cout << "Try 'janus --help' for more information.\n";
  }
