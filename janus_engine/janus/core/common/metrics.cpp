...
DEFINE_GAUGE(janus_cpu_num, "The cpu number pre instance for janus");
DEFINE_GAUGE(janus_cpu_utilization, "The cpu utilization pre instance for janus");
DEFINE_GAUGE(janus_gpu_num, "The gpu number pre instance for janus");
DEFINE_GAUGE(janus_gpu_utilization, "The gpu utilization pre instance for janus");
