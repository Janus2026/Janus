...
void WorkerService::ExecuteModel(::google::protobuf::RpcController* controller,
                                 ...
                                 ::google::protobuf::Closure* done) {
  JANUS_DLOG(INFO) << "[DIAG-WS] ExecuteModel called (before threadpool schedule)";
  threadpool_->schedule(
      [this, controller, pb_forward_input, pb_forward_output, done]() mutable {
        JANUS_DLOG(INFO) << "[DIAG-WS] ExecuteModel lambda entered";
        brpc::ClosureGuard done_guard(done);

        Timer timer;
        ForwardInput forward_input;
        JANUS_DLOG(INFO) << "[DIAG-WS] proto_to_forward_input starting";
        proto_to_forward_input(
            pb_forward_input, forward_input, options_.num_decoding_tokens());
        JANUS_DLOG(INFO) << "[DIAG-WS] proto_to_forward_input done, calling step()";
        ...
        step(forward_input,
             ...
             out_tokens,
             out_logprobs);
        JANUS_DLOG(INFO) << "[DIAG-WS] step() completed";
