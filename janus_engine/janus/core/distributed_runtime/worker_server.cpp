...
#if defined(USE_NPU)
#include "hccl/hccl.h"
#include "janus_atb_layers/core/include/atb_speed/base/external_comm_manager.h"
#include "janus_atb_layers/core/include/atb_speed/utils/singleton.h"
...
void WorkerServer::prepare_shm(
  ...
  if (options.is_local() && options.enable_shm()) {
    ...
    std::string name_prefix =
        "janus_" + net::extract_port(options.master_node_addr().value());
