...
void InitGlog(const std::string& log_dir) {
  ...
  if (!g_glog_inited) {
    ...
    google::SetLogDestination(google::INFO,
                              (log_dir + "/janus.log.INFO.").c_str());
    google::SetLogDestination(google::WARNING,
                              (log_dir + "/janus.log.WARNING.").c_str());
    google::SetLogDestination(google::ERROR,
                              (log_dir + "/janus.log.ERROR.").c_str());
...
JANUS_Response LLM::Completions(const std::string& model_id,
...
JANUS_Response LLM::ChatCompletions(
