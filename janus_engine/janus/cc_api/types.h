...
struct JANUS_CAPI_EXPORT JANUS_ChatMessage {
...
struct JANUS_CAPI_EXPORT JANUS_InitLLMOptions {
...
struct JANUS_CAPI_EXPORT JANUS_RequestParams {
...
enum JANUS_CAPI_EXPORT JANUS_StatusCode {
...
struct JANUS_CAPI_EXPORT JANUS_Usage {
...
struct JANUS_CAPI_EXPORT JANUS_LogProbData {
  // Token
  std::string token;
...
struct JANUS_CAPI_EXPORT JANUS_LogProb {
  // Token
  std::string token;
  ...
  std::vector<JANUS_LogProbData> top_logprobs;
};

struct JANUS_CAPI_EXPORT JANUS_Choice {
  ...
  std::optional<JANUS_ChatMessage> message;

  // The log probabilities of output tokens.
  std::optional<std::vector<JANUS_LogProb>> logprobs;
...
struct JANUS_CAPI_EXPORT JANUS_Response {
  // Return code indicating request status (0 = success, non-zero = error)
  JANUS_StatusCode status_code = JANUS_StatusCode::kSuccess;
  ...
  std::vector<JANUS_Choice> choices;
