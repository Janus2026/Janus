...
class CustomQwen3NpuModelImpl : public QWen3ModelImpl {
 public:
  CustomQwen3NpuModelImpl(const ModelContext& context) : QWen3ModelImpl(context) {}
...
TORCH_MODULE(CustomQwen3NpuModel);

class CustomQwen3NpuForCausalLMImpl : public LlmForCausalLMImplBase<CustomQwen3NpuModel> {
 public:
  CustomQwen3NpuForCausalLMImpl(const ModelContext& context)
      : LlmForCausalLMImplBase<CustomQwen3NpuModel>(context) {}
};
TORCH_MODULE(CustomQwen3NpuForCausalLM);

// register the causal model
REGISTER_CAUSAL_MODEL(custom_qwen3_npu_vlm_text, CustomQwen3NpuForCausalLM);
