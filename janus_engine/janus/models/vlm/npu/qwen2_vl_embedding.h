...
template <>
class EmbeddingVLMImpl<janus::Qwen2_VLForEmbedding> : public EmbeddingVLM {
 public:
  EmbeddingVLMImpl(janus::Qwen2_VLForEmbedding model,
 ...
 private:
  janus::Qwen2_VLForEmbedding model_;
  torch::TensorOptions options_;
};
