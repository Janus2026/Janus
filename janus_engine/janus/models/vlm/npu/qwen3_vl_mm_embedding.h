...
template <>
class MMEmbeddingVLMImpl<janus::Qwen3_VLForMMEmbedding> : public MMEmbeddingVLM {
 public:
  MMEmbeddingVLMImpl(janus::Qwen3_VLForMMEmbedding model,
 ...
 private:
  janus::Qwen3_VLForMMEmbedding model_;
  torch::TensorOptions options_;
};
